    ...
    <div class="app-container">
            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
                    <el-form-item label="输入名称：">
                        <el-input style="width: 203px" v-model="listQuery.name" placeholder="学校名称"></el-input>
                    </el-form-item>
                  <el-form-item label="输入省份：">
                    <el-input style="width: 203px" v-model="listQuery.province" placeholder="省"></el-input>
                  </el-form-item>
                  <el-form-item label="输入城市：">
                    <el-input style="width: 203px" v-model="listQuery.city" placeholder="市"></el-input>
                  </el-form-item>
                </el-form>
            </div>
        </el-card>
        ...
        <div class="table-container">
            <el-table ref="schoolTable"
                ...
                <el-table-column label="1热门" align="center">
                    <template slot-scope="scope">{{scope.row.hot |formatStatus}}</template>
                </el-table-column>
                <el-table-column label="211" align="center">
                    <template slot-scope="scope">{{scope.row.is211 |formatStatus}}</template>
                </el-table-column>
                <el-table-column label="985" align="center">
                    <template slot-scope="scope">{{scope.row.is985|formatStatus}}</template>
                </el-table-column>
...
<script>
    import {fetchList, deleteSchool} from '@/api/ums/school'
